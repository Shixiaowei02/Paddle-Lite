...
bool AssignValueOpLite::AttachImpl(const cpp::OpDesc &op_desc,
  ...
  param_.dtype = op_desc.GetAttr<OpAttrType::INT>("dtype");
  if (op_desc.HasAttr("fp32_values")) {
    param_.fp32_values = op_desc.GetAttr<OpAttrType::FLOATS>("fp32_values");
  }
  if (op_desc.HasAttr("int32_values")) {
    param_.int32_values = op_desc.GetAttr<OpAttrType::INTS>("int32_values");
  }
  if (op_desc.HasAttr("int64_values")) {
    param_.int64_values = op_desc.GetAttr<OpAttrType::LONGS>("int64_values");
  }
  if (op_desc.HasAttr("bool_values")) {
    param_.bool_values = op_desc.GetAttr<OpAttrType::INTS>("bool_values");
  }
