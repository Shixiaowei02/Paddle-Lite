...
add_cuda_static_lib(cudart CUDNN_CHECK_LIBRARY_DIRS libcudart.so)
add_cuda_static_lib(cublas CUDNN_CHECK_LIBRARY_DIRS libcublas.so)
add_cuda_static_lib(curand CUDNN_CHECK_LIBRARY_DIRS libcurand.so)
...
if(NOT ${CUDA_VERSION} LESS 10.1)
  add_cuda_static_lib(cublasLt CUDNN_CHECK_LIBRARY_DIRS libcublasLt.so)
  #add_cuda_static_lib(cublasLt_static CUDNN_CHECK_LIBRARY_DIRS libcublasLt_static.a)
endif()

set_property(GLOBAL PROPERTY CUDA_STATIC_MODULES cudnn ${CUDA_STATIC_MODULES})
